const projectsData = [
  ...
  {
    title: 'Defaults',
    description: 'Helper aliases and functions for rapid CLI debugging.',
    imgSrc: '/static/images/defaults.png',
    href: '/blog/defaults',
    showProject: true,
  },
  {
  ...
  {
    title: 'Sirtet',
    description: 'Reverse Tetris to learn about Unity game dev.',
    imgSrc: '/static/images/time-machine.jpg',
    href: '/blog/sirtet',
    showProject: false,
  },
  {
    title: 'Game of Life',
    description: 'Fun coding challenge to calculate cell position afer n generations.',
    imgSrc: '/static/images/time-machine.jpg',
    href: '/blog/gameoflife',
    showProject: false,
  },
  {
    title: 'Pole Paradise Studio',
    description: '',
    imgSrc: '/static/images/time-machine.jpg',
    href: '/blog/poleparadisestudio',
    showProject: false,
  },
]
