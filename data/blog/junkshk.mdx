...
I engineered Junks.hk, utilizing React and PostgreSQL, with Redis for session storage and Redux for state management. Ben contributed to the aesthetics of the site with HTML and CSS. While the site is no longer active, it's archived and viewable via the [web archive](https://web.archive.org/web/20220814022955/https://junks.hk ).
...
Despite the end of Junks.hk, the venture was an invaluable learning experience in starting and running a business, self-performing marketing, and maintaining a robust digital infrastructure on AWS. The platform was profitable from inception, thanks to our in-house development, and was designed for high user traffic and interaction, mainly client-side to ensure performance efficiency.
