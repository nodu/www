---
title: CLI Defaults
date: '2023-12-13T15:40:00Z'
tags: ['linux', 'github', 'cli', 'debugging']
draft: false
summary: Helper aliases and functions for rapid CLI debugging.
layout: PostLayout
images: [/static/images/defaults.png]
---
![CLI](/static/images/defaults.png)
When I'm debugging systems, like kubernetes or VMs, or checking network connectivity, I often times lack efficiency because I make heavy use of aliases and functions in my CLI.
